...
<body lang="en">
    ...
    <?php session_start();?>
        ...
        <div class="pt-2">
            <h5 class="text-center bt-1">Don't have an account ? <a href="sign-up.php" class="text-decoration-none">Sign up</a>
            </h5>
                ...
                <div class="row">
                    <div class="col-md-5 mx-auto">
                        <div class="card card-body">
                            ...
                            <form role="form" enctype="multipart/form-data" method="post" action="signin.php">
                                ...
                                <div class="form-group">
                                    <label style="font-size: larger;">User Type*:</label>
                                    <input type="text" class="form-control" name="user_type">
                                </div></br>
                                <div class="form-group">
                                    <p style="text-align:center"><a href="forgetpassword.php">Forget Password</a></p>
                                </div>
        ...
        if (isset($_POST['id']) && isset($_POST['password']) && isset($_POST['user_type'])) {
            ...
            $sql = "SELECT * FROM user WHERE user_id = '$u' AND password = '$p' AND user_type='$z'";
            ...
            if (mysqli_num_rows($result) != 0) {
                ...
                if ($z == 'customer') {
                    echo "<script>window.location.href='custprofile.php'</script>";
                } elseif ($z == 'shop owner') {
                    echo "<script>window.location.href='shopOwner.php'</script>";
                } else {
