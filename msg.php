...
<body lang="en">
    ...
    <body>
        ...
        <p><h1 style="text-align:center; color:mediumslateblue">THANK YOU!</h1></p>
        <p style="text-align:center"><a href="aboutus.php" class="btn btn-outline-success btn-rounded fs-5 my-auto " data-mdb-ripple-color="dark" href="support.php" role="button">About Us</a></p>
