...
<body lang="en">
    ...
    <body>
        ...
        <div class="text-center mb-3" style="color:#00BF9F ;">
            <p class="fs-4">CREATE AN ACCOUNT WITH US!</p>
        </div>
        <div class="d-flex justify-content-center gap-5 mb-5 pb-5">

            <a class="btn btn-outline-success btn-rounded fs-5 my-auto" data-mdb-ripple-color="dark" href="customersignup.php" type="button">
                Customer
            </a>
            <a class="btn btn-outline-success btn-rounded fs-5 my-auto " data-mdb-ripple-color="dark" href="shopownersignup.php" role="button"> Shop Owner
            </a>

        </div>
        <footer style="background-color:#000000 ;" class="mt-5">
            <div>
                <div>
