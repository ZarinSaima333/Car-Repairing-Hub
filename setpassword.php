...
<body lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 mx-auto">
                        ...
                        <form role="form" enctype="multipart/form-data" method="post" action="setpassword.php">
        ...
        <?php
        if(isset($_POST['id']) && isset($_POST['new_pass']) && isset($_POST['cnew_pass'])){
        $id = $_POST['id'];
        $np = $_POST['new_pass'];
        $cnp = $_POST['cnew_pass'];
        if($np==$cnp)
            ...
            if ($mehedi!=0)
            {
                $query="update user set password='$np' where user_id='$id'";
                $result=mysqli_query($conn,$query);
