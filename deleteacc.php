...
<body lang="en">
    ...
    <body>
            ...
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <div class="card card-body">
                        <form role="form" enctype="multipart/form-data" method="post" action="deleteacc.php">
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="passsword" class="form-control" name="password">
                            </div></br>
        ...
        <!-- PHP CODE & SQL COMMANDS TO CHANGE CUSTOMERS'S PHONE NUMBER -->
        <?php
        if (isset($_POST['id']) &&  isset($_POST['password'])) {
            $id = $_POST['id'];
            $password = $_POST['password'];

            $sql1 = "SELECT * from user where user_id='$id' AND password='$password' ";
            $result = mysqli_query($conn, $sql1);
            if (mysqli_num_rows($result) > 0) {
                $sql2 = "DELETE from user where user_id='$id' AND password='$password'";
