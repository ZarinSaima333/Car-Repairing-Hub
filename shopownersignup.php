...
<body lang="en">
    ...
    <body>
        ...
        <div class="container ">
            <img class="img-fluid rounded mx-auto d-block w-50 h-50"
                src="https://media.discordapp.net/attachments/939266966265417768/1053524529370124328/logo_2.png"
                alt="logo">
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 mx-auto">
                        ...
                        <form role="form" enctype="multipart/form-data" method="post" action="shopownersignup.php">
                                <div class="form-group">
                                    <label style="font-size: larger;">UserID:</label> 
                                    <input type="int" class="form-control" name="userid" placeholder="User Id">
                                </div></br>
                                <div class="form-group">
                                    <label style="font-size: larger;">Name:</label> 
                                    <input type="int" class="form-control" name="name" placeholder="Name">
                                </div></br>
                                <div class="form-group">
                                    <label style="font-size: larger;">Road:</label> 
                                    <input type="int" class="form-control" name="road" placeholder="Road">
                                </div></br>
                                <div class="form-group">
                                    <label style="font-size: larger;">Area:</label> 
                                    <input type="int" class="form-control" name="area" placeholder="Area">
                                </div></br>
                                <div class="form-group">
                                    <label style="font-size: larger;">City:</label> 
                                    <input type="int" class="form-control" name="city" placeholder="City">
                                </div></br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label style="font-size: larger;">License:</label> 
                                    <input type="int" class="form-control" name="licence" placeholder="License">
                                </div></br>
        ...
        <?php
        if(isset($_POST['userid']) && isset($_POST['name']) && isset($_POST['road']) && isset($_POST['area']) && isset($_POST['city']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['password']) && isset($_POST['cpassword']) && isset($_POST['license'])){
            $a = $_POST['userid'];
            $b = $_POST['name'];
            $c = $_POST['road'];
            $d = $_POST['area'];
            ...
            if($mehedi==0){
                if($h==$i){
                    $sql="INSERT INTO `user` (`user_id`, `name`, `road`, `area`, `city`, `email`, `phone`, `password`, `user_type`) VALUES ('$a', '$b', '$c', '$d', '$e', '$f', '$g', '$h', 'Shop Owner')";  
                    $result=mysqli_query($conn, $sql); 
                    $sqlcode="INSERT INTO `shop_owner` (`owner_id`, `license_no`) VALUES ('$a', '$k')";
                ...
                echo"Your mail or phone or userID number have already used";
            }    
    }
